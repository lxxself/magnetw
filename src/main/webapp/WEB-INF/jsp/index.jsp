...
<head>
    ...
    <script src="../static/js/dist/vue-clipboard.min.js"></script>
    <script src="../static/js/dist/base64.min.js"></script>
                    ...
                    <el-col :span="12" class="option-left">
                        <span v-show="multipleSelection.length>0">
                             <el-popover
                                     ...
                                     trigger="hover">
                            <span slot="reference"
                                  class="multiple-selection-message">当前选中：{{multipleSelection.length}}个</span>
...
<script>
    function onVueCreated(vue) {
        ...
        console.log(vue._data.config);
        console.log(vue._data.current);
